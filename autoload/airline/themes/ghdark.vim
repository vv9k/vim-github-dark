...
let g:airline#themes#ghdark#palette.normal.airline_error = [ base0, lightred, '', '' ,'bold']
let g:airline#themes#ghdark#palette.normal.airline_warning = [ base0, yellow, '', '' , 'bold']
...
let g:airline#themes#ghdark#palette.insert.airline_error = [ base0, lightred, '', '' ,'bold']
let g:airline#themes#ghdark#palette.insert.airline_warning = [ base0, yellow, '', '' , 'bold']
...
let g:airline#themes#ghdark#palette.replace.airline_error = [ base0, lightred, '', '' ,'bold']
let g:airline#themes#ghdark#palette.replace.airline_warning = [ base0, yellow, '', '' , 'bold']
...
let g:airline#themes#ghdark#palette.visual.airline_error = [ base0, lightred, '', '' ,'bold']
let g:airline#themes#ghdark#palette.visual.airline_warning = [ base0, yellow, '', '' , 'bold']
