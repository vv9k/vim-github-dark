...
if exists('g:lightline')
    ...
    let s:p.insert.left = [ [ s:base0, s:lightred, 'bold' ], [ s:base5, s:base2, 'bold' ] ]
    ...
    let s:p.terminal.left = [ [ s:base0, s:yellow, 'bold' ], [ s:base5, s:base2, 'bold' ] ]
    let s:p.terminal.right = [ [ s:base0, s:yellow ], [ s:base5, s:base2 ] ]
    let s:p.terminal.middle = [ [ s:base4, s:base2 ] ]

    let s:p.visual.left = [ [ s:base0, s:lightpurp, 'bold' ], [ s:base5, s:base2, 'bold' ] ]
