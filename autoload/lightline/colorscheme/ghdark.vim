...
let base2      = g:github_colors["base2"][0]
let base3      = g:github_colors["base3"][0]
let base4      = g:github_colors["base4"][0]
let base5      = g:github_colors["base5"][0]
...
let lightgreen = g:github_colors["lightgreen"][0]
...
let s:p.normal.right = [ [ s:base0, s:base3 ], [ s:base4, s:base2 ] ]
